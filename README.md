...
[![Run on Brainlife.io](https://img.shields.io/badge/Brainlife-bl.app.72-blue.svg)](https://doi.org/10.25663/brainlife.app.72)

# Dipy Denoise Diffusion MRI using NLmeans

The App uses the Non Local Means (NLmeans) method to denoise diffusion-weighted magnetic resonance imaging data.
...
### DIPY
- This is a Brainlife wrapper App stemming from the [`dipy_denoise_nlmeans`](https://dipy.org/documentation/latest/reference_cmd/dipy_denoise_nlmeans/) workflow.
